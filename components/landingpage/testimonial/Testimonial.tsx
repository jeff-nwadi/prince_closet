  ...
  return (
    <div data-scroll-section className='py-20 lg:py-32 px-3 lg:px-16 bg-[#f4f0ea]'>
      ...
      <div className='bg-[#e3dbcf] h-screen md:h-[40vh] lg:h-[90vh]'>
        <div>
          <div key={item.id} className='flex flex-col gap-16 md:flex-row justify-between p-3 lg:p-15'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='border-[#4a3129] border-2 mt-5 py-2 px-6 text-center cursor-pointer'>
        ...
        <div className='flex gap-2 px-15 pb-8'>
